package com.Gaurav.ServiceIMPLGaurav;
...
import com.Gaurav.ExceptionGaurav.CategoryNotFoundException;
import com.Gaurav.ExceptionGaurav.PrductNotFoundException;
import com.Gaurav.RepositoryGaurav.CategoryRepo;
import com.Gaurav.RepositoryGaurav.Productrepo;
import com.Gaurav.ServiceGaurav.productService;
...
public class PrductServiceIMPL implements productService {
	...
	public ResponseProduct addProduct(RequestProduct requestproduct) {
		...
		if (pr.existsById(requestproduct.getProductID())) {
			throw new PrductNotFoundException("Product Not Found Exception");
		}
